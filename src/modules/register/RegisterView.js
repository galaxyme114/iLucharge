...
export default function RegisterView(props) {
  ...
  const onClickRegister = async () => {
    ...
    await firebase.auth().createUserWithEmailAndPassword(userInfo.email, userInfo.password).then(async (res) => {
      try {
      ...
      if (error.code === 'auth/email-already-in-use') _validUserInfo.passwordErr = error.message;
      else _validUserInfo.emailErr = 'That email address is invalid!';
      setValidUserInfo({..._validUserInfo});
    })
  }
          ...
          <View style={styles.wrapper}>
              ...
              <SafeAreaView style={styles.container}>
                <ScrollView>
                  <View style={styles.scrollContent}>
                    ...
                    <View style={styles.flexItemContainer}>
                      <TouchableOpacity style={styles.SignupButton} onPress={onClickRegister}>
                        <ImageBackground
            ...
            <View style={styles.rememberContainer}>
              <View style={styles.forgotPasswordButton}>
                ...
                <TouchableOpacity onPress={() => props.navigation.navigate('Home', { screen: 'Login'})} style={styles.signupButton}>
